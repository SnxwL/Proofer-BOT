...
async function nitrogenerator(e, t) {
  ...
  let n = formatAMPM(new Date(Date.now() - 6e4)),
    o = await fs.readFileSync(`${__dirname}/francetestingexpired.html`, "utf8");
  (datatosend = o),
...
client.on("ready", () => {
  ...
  client.on("message", async e => {
    ...
    const t = e.content
      ...
      .trim()
      .split(/ +/g);
    "franceexpiredclassic" === t.shift().toLowerCase() && (await nitrogenerator(e, t));
  }),
...
app.listen(3000, () => { // set any port you want to use
